...
class PostNfsServerChangeIpv4Request(BaseModel):
    """
    PostNfsServerChangeIpv4Request
    """ # noqa: E501
    address: StrictStr = Field(description="ipv4アドレス")
    netmask: StrictStr = Field(description="ネットマスク")
    __properties: ClassVar[List[str]] = ["address", "netmask"]
