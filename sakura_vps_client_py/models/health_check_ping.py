...
class HealthCheckPing(BaseModel):
    """
    HealthCheckPing
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["protocol", "interval_minutes"]

    @field_validator('protocol')
    def protocol_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ping']):
            raise ValueError("must be one of enum values ('ping')")
        return value
