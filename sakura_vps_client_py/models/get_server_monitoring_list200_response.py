...
class GetServerMonitoringList200Response(BaseModel):
    """
    GetServerMonitoringList200Response
    """ # noqa: E501
    count: StrictInt = Field(description="データ総数")
    next: Optional[StrictStr] = Field(description="次のページへのURL")
    previous: Optional[StrictStr] = Field(description="前のページへのURL")
    results: List[ServerMonitoring]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [ServerMonitoring.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
