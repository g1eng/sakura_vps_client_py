...
class HealthCheckHttps(BaseModel):
    """
    HealthCheckHttps
    """ # noqa: E501
    ...
    sni: StrictBool = Field(description="SNIを設定しているWebサーバか * true SNI設定あり * false SNI設定なし")
    __properties: ClassVar[List[str]] = ["port", "host", "path", "basic_auth_username", "basic_auth_password", "status", "interval_minutes", "protocol", "sni"]
