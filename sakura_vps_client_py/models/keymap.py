...
class Keymap(BaseModel):
    ...
    Keymap
    """ # noqa: E501
    layout: StrictStr = Field(description="指定したいキー配列の名称")
    __properties: ClassVar[List[str]] = ["layout"]

    @field_validator('layout')
    def layout_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ja', 'en-us']):
            raise ValueError("must be one of enum values ('ja', 'en-us')")
        return value
