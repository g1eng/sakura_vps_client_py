...
class Disc(BaseModel):
    ...
    license_required: StrictBool = Field(description="ライセンスが必要かどうか")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "license_required"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "license_required": obj.get("license_required")
        })
        return _obj
