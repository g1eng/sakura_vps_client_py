...
class SwitchExternalConnectionServicesInner(BaseModel):
    """
    SwitchExternalConnectionServicesInner
    """ # noqa: E501
    service_category: StrictStr = Field(description="サービスカテゴリー")
    service_name: StrictStr = Field(description="サービス名")
    switch_code: StrictStr = Field(description="スイッチコード")
    __properties: ClassVar[List[str]] = ["service_category", "service_name", "switch_code"]
